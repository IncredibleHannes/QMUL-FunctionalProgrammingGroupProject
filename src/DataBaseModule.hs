...
initialiseDB conn = do
   run conn "CREATE TABLE movies (id BIGINT(11), name VARCHAR(40))" []
   run conn "CREATE TABLE actores (id BIGINT(11), name VARCHAR(40))" []
   run conn "CREATE TABLE plays (actor BIGINT(11), movie BIGINT(11))" []
